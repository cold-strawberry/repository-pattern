...
namespace Premium.Commons.Handlers
{
	public class Handler : IHandler
	{
        ...
        private Func<PremiumException, Task> _onCustomError;
        ...
        public IHandler OnCustomError(Func<PremiumException, Task> onCustomError, bool rethrow = false)
        {
        ...
        public async Task ExecuteAsync()
        {
            ...
            catch (PremiumException customException)
            {
                isFailure = true;
